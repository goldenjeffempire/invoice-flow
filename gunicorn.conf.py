...
# Note: All format specifiers use %(name)s for string values
# - %(p)s is worker PID (string, not integer despite Gunicorn v23 docs)
# - %(D)s is response time in microseconds (string)
access_log_format = (
