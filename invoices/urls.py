...
urlpatterns = [
    ...
    # ── Legacy / backward-compat email verify stubs (no-op redirects) ────────
    ...
    # ── MFA (for users who already have it enabled) ───────────────────────────
    ...
    path("onboarding/start/", onboarding_views.onboarding_router, name="onboarding"),
    path("onboarding/wizard/", onboarding_views.onboarding_router, name="onboarding_wizard"),
    ...
    path("settings/business/", views.settings_business_update, name="settings_business_update"),
    path("settings/branding/", views.settings_branding_update, name="settings_branding_update"),
    ...
    path("payments/history/", payment_views.transaction_list, name="payment_history"),
    ...
    path("invoices/list/", invoice_views.invoice_list, name="invoices_list"),
    ...
    path("invoices/<int:invoice_id>/reminders/toggle/", invoice_views.toggle_invoice_reminders, name="toggle_invoice_reminders"),
    path("invoices/<int:invoice_id>/reminders/send/", invoice_views.send_manual_reminder, name="send_manual_reminder"),
    ...
    path("settings/workspace/create/", workspace_views.workspace_create, name="workspace_create"),
    ...
    path("estimates/<int:estimate_id>/send/", estimate_views.estimate_send, name="estimate_send"),
    path("estimates/<int:estimate_id>/void/", estimate_views.estimate_void, name="estimate_void"),
    path("estimates/<int:estimate_id>/duplicate/", estimate_views.estimate_duplicate, name="estimate_duplicate"),
    path("estimates/<int:estimate_id>/convert/", estimate_views.convert_estimate, name="convert_estimate"),
    path("q/<str:token>/", estimate_views.public_estimate_view, name="public_estimate"),
    path("q/<str:token>/<str:action>/", estimate_views.public_estimate_action, name="public_estimate_action"),
